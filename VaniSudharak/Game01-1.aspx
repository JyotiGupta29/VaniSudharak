<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Game01-1.aspx.cs" Inherits="VaniSudharak.Game01_1" %>
...
<body>
    <form id="form1" runat="server">
         <div class="auto-style1" style="background-color: #006666">
            ...
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" OnClick="Button1_Click" Text="Next&gt;" CssClass="button" PostBackUrl="~/Game01-2.aspx" />
            <br />
            <br />
            <br />
        </div>
